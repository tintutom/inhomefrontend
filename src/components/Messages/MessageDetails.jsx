                ...
                <div className="row g-0">
                  <div className="col-12 col-lg-5 col-xl-3 border-right">
                      <div className="px-4 ">
                        ...
                        <h2 href="#" className="list-group-item list-group-item-action border-0">
                          <small><div className="badge bg-success float-right text-white">4:23</div></small>
                            <div className="d-flex align-items-start">
                              <img src='' className="rounded-circle mr-1" alt="2" width={40} height={40}/>
