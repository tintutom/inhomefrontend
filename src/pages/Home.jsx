      ...
      <div className='container'>
        <div className='flex items-center justify-between flex-col lg:flex-row'>
          <div className='xl:w-[670px]'>
            ...
            <ul className='pl-4'>
              <li className='text__para'>
                1. Schedule appoinment directly.
              </li>
              <li className='text__para'>2. search your Doctor here and Book an Appoinemt</li>
              <li className='text__para'>3. View our doctors who are accepting new appoinments, use online scheduling tools to select an appoinmet time.</li>
          ...
          [100px] md:left-5 z-20 p-2 pb-3 lg:px-4 lg:pb-[26px] rounded-[10px]'>
            ...
            <div className='flex items-center gap-[6px] ig:gap-[10px] mt-2 lg:mt-[18px]'>
