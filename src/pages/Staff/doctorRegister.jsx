...
function DoctorRegister() {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      toast.error("Please fix details correctly.", { autoClose: 20000 });
      return;
    }
    ...
    if (
      ...
      toast.error("Please fill all the required fields.", { autoClose: 20000 });
      return;
    }
    ...
    formData.append('admin_position', admin_position);
    ...
    axios.post(hospitalSignup, formData)
      .then((response) => {
        toast.success("Registered successfully. You can login when admin approves your account", {
          autoClose: 40000,
        });
